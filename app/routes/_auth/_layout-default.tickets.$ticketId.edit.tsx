...
export const Route = createFileRoute(
  ...
  loader: async (opts) => {
    ...
    return Promise.all([
      opts.context.queryClient.ensureQueryData((ticketInfoOptions as any)({ ticketId })),
...
function EditTicketPage() {
  ...
  const { data: ticketData } = useSuspenseQuery(ticketInfoOptions({ ticketId }));
              ...
              children={(field) => (
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(val: string) =>
                      field.handleChange(
                        val as "Open" | "In Progress" | "Completed"
                      )
                    }
                  >
                    <SelectTrigger>
