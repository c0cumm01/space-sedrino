...
function CreateTicketPage() {
  ...
  const form = useForm({
    ...
    onSubmit: async ({ value }) => {
      const systemsArray = value.ticket.affectedSystems
        ? value.ticket.affectedSystems.split(",").map((s) => s.trim())
        : [];
      const payload = {
        ticket: {
          issueDescription: value.ticket.issueDescription,
          priority: value.ticket.priority,
          assignedCrewTeamId: value.ticket.assignedCrewTeamId,
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(val: string) =>
                      field.handleChange(val as "Low" | "Medium" | "High")
                    }
                  >
                    <SelectTrigger>
